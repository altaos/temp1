...
namespace AliveChessLibrary.GameObjects.Characters
{
    ...
    public class King : MovingEntity, IKing, IEquatable<int>, ISinglePoint
    {
        ...
        public virtual void AddView(MapPoint point)
        {
            ...
            this._viewOnMap.ObjectUnderThis = Map[point.X, point.Y];
        ...
        public virtual void MoveBy(int x, int y)
        {
            ...
            if ((this.PrevX != x || this.PrevY != y) && Map.Locate(x, y))
            {
                ...
                _viewOnMap.ObjectUnderThis = Map[x, y];
        ...
        {
            return Castles.Exists(x => x.MapSectorId == point.Id);
        }
        ...
        {
            return Mines.Exists(x => x.MapSectorId == point.Id);
        }
        ...
        protected void DoStep(int x, int y)
        {
            ...
            else if (handlers.ContainsKey(String.Concat("Find", objectType)))
                handlers[String.Concat("Find", objectType)].Invoke(mObject);
        }
        ...
        protected void FindResource(MapPoint resource)
        {
            ...
            if (ChangeMapStateEvent != null)
                ChangeMapStateEvent(this, Map, resource.ObjectUnderThis);
        }
        ...
        public virtual int StepCount { get { return steps.Count; } }
